...
// */
//
//public class StaggeredHorizontalRecyclerView extends BaseRecyclerView<StaggeredHorizontalRecyclerView>  implements ILinearRecyclerView {
//    private LinearItemDecoration linearItemDecoration;
//    private int downX; // 按下时 X轴坐标值
//    private int downY; // 按下时 Y 轴坐标值
//    public StaggeredHorizontalRecyclerView(Context context) {
//        this(context, null);
//    }
//
//    public StaggeredHorizontalRecyclerView(Context context, @Nullable AttributeSet attrs) {
//        super(context, attrs);
